        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                 ...
                 <img class="img-rounded" src="images/food-picky-logoa.png" alt="logo" style="width: 150px; height: 50px;"> 
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
                        ...
                        $query_res= mysqli_query($db,"select * from dishes ORDER BY d_id DESC limit 20"); 
